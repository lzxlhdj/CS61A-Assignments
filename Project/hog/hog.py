...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    sub = abs((opponent_score // 10 % 10) - player_score % 10)
    if sub == 0 :
        return 1
    else :
        return sub * 3
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    for i in range(1, 11):
        averaged_result = averaged_dice(i, dice) 
        if averaged_result > max_average :
            max_scoring_num = i
            max_average = averaged_result
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    num_rolls = 6
    if sus_update(0, score, opponent_score) > sus_update(num_rolls, score, opponent_score):
        return 0
    else :
        return num_rolls
    # END PROBLEM 12
